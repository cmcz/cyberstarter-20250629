/*
  # Add Demo Challenge with Instructor

  1. New Data
    - Create instructor profile first (without auth.users dependency)
...
-- First, temporarily disable the foreign key constraint on profiles
-- This allows us to insert a profile without requiring auth.users entry
