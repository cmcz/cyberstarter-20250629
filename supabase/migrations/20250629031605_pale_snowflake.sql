/*
  # Add Demo Challenge with Proper Schema Structure

  1. New Data
    - Demo challenge instructor profile
    - Demo challenge (using challenges table)
    - Demo challenge modules (using modules table with course_id pointing to challenge)
    - Demo challenge lessons with code challenge content

  2. Schema Notes
    - The modules table references courses.id, but we're creating a challenge
    - We need to insert the challenge into both challenges and courses tables
    - Or we need to modify the approach to work with the existing schema
*/

-- First, temporarily disable foreign key constraints to insert demo data
SET session_replication_role = replica;

-- Insert demo challenge instructor profile
INSERT INTO profiles (
  ...
  'challenge.instructor@learnhub.com',
  'Challenge Master',
  'instructor',
...
-- Insert demo challenge into courses table (since modules references courses)
INSERT INTO courses (
  id,
  title,
  description,
  ...
  '88888888-8888-8888-8888-888888888888',
  'web-development',
  'coding', -- Use coding type for challenges
  'beginner',
  4,
  0, -- Free challenge
  true,
...
-- Also insert into challenges table for challenge-specific functionality
...
-- Insert challenge module (now references the course entry)
INSERT INTO modules (
  id,
  course_id,
  title,
