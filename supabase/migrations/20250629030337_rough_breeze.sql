/*
  ...
  Note: Profile creation removed as it should be handled through auth registration
*/

-- Insert demo challenge (using existing instructor profile)
INSERT INTO challenges (
  ...
  '77777777-7777-7777-7777-777777777777', -- Use existing demo instructor
  'web-development',
  'algorithm',
  'beginner',
  4,
